...
Source: https://developer.officernd.com/reference/paymentscontroller_addoverpayment
...
The line items of the overpayment.
...
The conversion rate for the currency of the payment. If the payment's currency is different from the default currency,
this rate will be used to convert the payment amount to the default currency.
...
The accounting data of the overpayment.
...
curl --request POST \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/payments \
