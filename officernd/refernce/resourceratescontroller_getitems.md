...
Source: https://developer.officernd.com/reference/resourceratescontroller_getitems
...
curl --request GET \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/resource-rates \
