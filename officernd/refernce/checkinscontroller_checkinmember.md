...
Source: https://developer.officernd.com/reference/checkinscontroller_checkinmember
...
curl --request POST \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/checkins/memberId \
