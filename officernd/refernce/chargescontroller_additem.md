...
Source: https://developer.officernd.com/reference/chargescontroller_additem
...
The status of the charge. If not specified the default status is "Success".

successpendingfailsuccessrefund
