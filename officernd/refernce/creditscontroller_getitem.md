# Retrieve single set of credits.

Source: https://developer.officernd.com/reference/creditscontroller_getitem
...
curl --request GET \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/credits/creditsId \
