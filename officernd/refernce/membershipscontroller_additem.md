...
Source: https://developer.officernd.com/reference/membershipscontroller_additem
...
The type of the membership. If "fixed", the membership will be charged for a fixed period of time and the end date is required.

month\_to\_monthmonth\_to\_monthfixed
...
curl --request POST \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/memberships \
