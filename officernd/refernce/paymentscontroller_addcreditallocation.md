...
Source: https://developer.officernd.com/reference/paymentscontroller_addcreditallocation
...
curl --request POST \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/payments/paymentId/allocations \
