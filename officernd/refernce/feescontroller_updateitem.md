# Update and existing fee

Source: https://developer.officernd.com/reference/feescontroller_updateitem
...
curl --request PUT \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/fees/feeId \
