...
Source: https://developer.officernd.com/reference/bookingscontroller_validatebooking
...
curl --request POST \
     ...
     --url https://app.officernd.com/api/v2/organizations/orgSlug/bookings/validate \
